...
const Logo = ({ size }) => (
  <div className="Logo">
    ...
    >
      ...
      {/* Modification de 'white-space' en 'whiteSpace' pour corriger l'avertissement de propriété de style non prise en charge.*/}
      {/*Changed 'white-space' to 'whiteSpace' to fix the unsupported style property warning */}
      <text
        fill="url(#paint5_linear_56_57)"
        style={{
